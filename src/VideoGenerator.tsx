        ...
        {meditationDuration > 0 && (
          <div className="mb-5">
            ...
            <div className="space-y-1.5 bg-[var(--bg-surface)] border border-[var(--border)] rounded p-3">
              ...
              <TimelineRow name="Music" track={musicTrack} totalDuration={totalDuration} color="#7b5cff" />
              <TimelineRow name="Image" track={imageTrack} totalDuration={totalDuration} color="#4a1d8c" />
              <TimelineRow name="Subtitle" track={subtitleTrack} totalDuration={totalDuration} color="#d63b8c" />
