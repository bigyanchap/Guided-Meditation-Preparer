...
export default function App() {
  ...
  return (
    <div className="h-screen flex bg-[var(--bg)] text-[var(--text-primary)] font-sans select-none">
      ...
      {/* Sidebar */}
      <nav className="w-11 shrink-0 bg-[var(--bg-sidebar)] border-r border-[var(--border)] flex flex-col items-center pt-2 gap-0.5">
        <img
          src="/logo.png"
          alt="ZenGM"
          title="ZenGM"
        ...
        <div className="mt-auto mb-2 flex flex-col items-center gap-1">
          ...
          <a
            href="https://github.com/bigyanchap/Guided-Meditation-Preparer"
            target="_blank"
            ...
            onClick={(e) => {
              if (window.electronAPI) {
                e.preventDefault();
                void window.electronAPI.openExternal('https://github.com/bigyanchap/Guided-Meditation-Preparer');
              }
            }}
          >
                ...
                <div className="relative flex rounded-full p-[3px] border border-[var(--glass-border)]" style={{ background: 'var(--glass-bg)', backdropFilter: 'blur(12px)' }}>
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: '0 2px 8px rgba(214,59,140,0.2)',
                      width: 'calc(50% - 3px)',
                    }}
